...
<?php
	...
	<?php endif; ?>
	<span class="section-hero-mask flex items-center justify-center absolute top-0 right-0 bottom-0 left-0 z-[42] clip-square bg-main-green">
		<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 150 235.9" class="section-hero-symbol fill-main-beige w-[90px] lg:w-[110px] " width="150" height="235.9" x="0" y="0" version="1.1">
