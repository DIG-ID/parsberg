...
?>
<section class="section-location bg-main-green flex flex-col justify-center items-center min-h-[100vw] lg:min-h-screen bg-center bg-no-repeat bg-cover" style="background-image: linear-gradient(0, rgb(46 86 89 / 80%), rgb(46 86 89 / 80%)), url('<?php echo esc_url( $hbg ); ?>')">
