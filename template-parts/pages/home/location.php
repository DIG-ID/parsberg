<?php
$bgi = get_field( 'location_section_image' );
if ( $bgi ) :
	$hbg = wp_get_attachment_image_url( $bgi, 'full' );
endif;
?>
<section class="section-location bg-main-green flex flex-col justify-center items-center min-h-[100vw] lg:min-h-screen bg-center bg-no-repeat bg-cover relative" style="background-image: url('<?php echo esc_url( $hbg ); ?>')">
	<span class="overlay absolute top-0 left-0 right-0 bottom-0 bg-main-green/75"></span>
	<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 150 235.9" class="section-hero-symbol fill-main-beige w-[50px] h-auto mb-10" width="150" height="235.9" x="0" y="0" version="1.1">
	...
	<p class="text-main-beige text-xl text-center leading-8 tracking-wider max-w-md"><?php the_field( 'location_section_description' ); ?></p>
</section>
