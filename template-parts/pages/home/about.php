<section class="section-about grid grid-cols-1 px-8 lg:px-0 lg:grid-cols-12 mb-24 lg:mr-14">
	...
	<div class="about-content col-span-1 lg:col-start-9 lg:col-span-3">
		...
		<p class="text-sm leading-8 tracking-wider mb-12"><?php the_field( 'about_us_section_description' ); ?></p>
		<a href="<?php the_field( 'about_us_section_button_url' ); ?>" class="inline-block lg:block text-sm text-center font-normal tracking-widest uppercase py-4 px-16 lg:px-0 border border-main-beige lg:w-full transition-all duration-500 ease-in-out hover:bg-main-green hover:border-main-green hover:text-main-beige"><?php the_field( 'about_us_section_button_name' ); ?></a>
	</div>
</section>
