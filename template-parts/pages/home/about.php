<section class="section-about grid grid-cols-1 px-8 lg:px-0 lg:grid-cols-12 mb-24 lg:mr-14">
	...
	if ( ! empty( $image ) ) :
		echo '<div class="image-wrapper col-span-1 mb-12 relative lg:mb-0 lg:col-span-7"><span class="overlay absolute top-0 left-0 right-0 bottom-0 bg-main-green/75 mix-blend-lighten"></span><img class="w-full object-cover max-h-[650px]" src=" '. esc_url( $image['url'] ) . '" alt="' . esc_attr( $image['alt'] ) . '" loading="lazy" /></div>';
	endif;
	?>
