<section class="section-connection grid grid-cols-1 lg:grid-cols-12 pb-20 lg:pb-40 px-8 lg:px-0">
	...
	<div class="col-span-1 lg:col-span-5 xl:col-start-2 xl:col-span-3 lg:ml-7 lg:mr-20">
		<p class="text-main-green text-sm font-light leading-8 tracking-wider mb-8 lg:mb-0"><?php the_field( 'activitities_connection_description', 'aktivitaten_archive' ); ?></p>
	</div>
	<div class="col-span-1 lg:col-span-7 xl:col-span-8">
		<?php
