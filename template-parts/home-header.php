	...
	<nav class="navbar fixed-top navbar-expand-lg" role="navigation" aria-label="<?php esc_attr_e( 'Main navigation', 'parsberg' ); ?>">
		<div class="container mx-auto px-8">
			<div class="columns-3 flex justify-between items-start group-[.main-header--scrolled]:items-center transition-all duration-500 ease-in-out">
				...
				<a class="site-logo absolute left-1/2 -translate-x-2/4 top-8 w-[200px] h-[200px] z-50 flex justify-center items-start" href="<?php echo esc_url( get_bloginfo( 'url' ) ); ?>">
					<?php get_template_part( 'template-parts/main-logo' ); ?>

					<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 150 235.9" id="main-symbol" class="section-hero-symbol fill-main-green w-[55px] mx-auto h-auto" width="150" height="235.9" x="0" y="0" version="1.1">
				...
				<a href="" class="button hidden lg:inline-block bg-main-green text-main-beige text-sm font-normal tracking-widest uppercase no-underline py-3.5 px-5 z-50" type="button">
