<section class="section-intro pt-10 lg:pt-24 pb-16 lg:px-8 xl:px-0">
	<div class="lg:container mx-auto grid grid-cols-1 lg:gap-8 px-8 lg:grid-cols-12">
		<div class="title col-span-1 lg:col-span-4">
			<h1 class="text-2xl lg:text-3xl font-bold lg:font-semibold mb-8 lg:mb-5 lg:w-full"><?php echo esc_html( wp_strip_all_tags( get_the_title() ) ); ?></h1>
