<section class="section-intro pt-24 pb-16 px-8 xl:px-0">
	<div class="lg:container mx-auto grid grid-cols-1 lg:gap-8 lg:grid-cols-12">
		...
		<a href="<?php the_field( 'booking_button_url' ); ?>" class="col-span-1 lg:col-start-10 lg:col-span-3 bg-main-green text-main-beige inline-block lg:block text-sm text-center font-normal tracking-widest uppercase py-4 px-12 lg:px-0 lg:w-full"><?php esc_html_e( 'Jetzt buchen', 'parsberg' ); ?></a>
		</div>
	</div>
</section>
