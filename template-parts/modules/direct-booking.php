<section class="section-direct-booking px-8 py-14 bg-main-green lg:px-0">
	<div class="lg:container mx-auto grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-center">
		...
		<div class="col-span-1 lg:col-start-10 lg:col-span-3">
			<a href="<?php the_field( 'direct_booking_section_button_url', 'option' ); ?>" class="bg-main-beige text-main-green inline-block lg:block text-sm text-center font-normal tracking-widest uppercase py-4 px-16 lg:px-0 lg:w-full"><?php the_field( 'direct_booking_section_button_name', 'option' ); ?></a>
		</div>
	</div>
</section>
